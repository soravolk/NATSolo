...
def cfp_feature_extraction(audio: np.array, sample_rate: int) -> np.array:
    ...
    Hop = fs * 32 // 1000 # hop size (in sample)
    ...
    # --- CFP Filterbank ---
    tfrL01, tfrLF1, tfrLQ1, f1, q1, t1, CenFreq1 = CFP_filterbank(audio[0].cpu(), fr, fs, Hop, h1, fc, tc, g, num_per_oct)
    tfrL02, tfrLF2, tfrLQ2, f2, q2, t2, CenFreq2 = CFP_filterbank(audio[0].cpu(), fr, fs, Hop, h2, fc, tc, g, num_per_oct)
    tfrL03, tfrLF3, tfrLQ3, f3, q3, t3, CenFreq3 = CFP_filterbank(audio[0].cpu(), fr, fs, Hop, h3, fc, tc, g, num_per_oct)
