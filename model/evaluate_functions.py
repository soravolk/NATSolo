...
def evaluate_prediction(data, model, save_path=None, reconstruction=True):
    ...
    for val_data in tqdm(data):
        ...
        print('(offset ratio)p: ', p)
        print('(offset ratio)r: ', r)
        print('(offset ratio)f: ', f)
        ...
        if reconstruction:
            ...
            print('(offset ratio)recon_p: ', p2)
            print('(offset ratio)recon_r: ', r2)
            print('(offset ratio)recon_f: ', f2)
